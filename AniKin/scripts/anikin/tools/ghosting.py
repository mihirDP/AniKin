"""
ghosting.py
Ghosting — wraps Maya's native ghosting features (Tier 1 MVP).
...
def is_ghosted(obj):
    """Check if an object is currently marked for ghosting."""
...
def toggle_ghosting():
    ...
    if not sel:
        cmds.warning("AniKin: Select objects to toggle ghosting.")
        return
