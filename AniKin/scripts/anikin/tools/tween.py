"""
tween.py
Tween/Breakdown Slider — interpolates between neighboring keyframes.
...
- bias = 0.0  → value at previous key
- bias = 0.5  → midpoint (default Maya interpolation)
- bias = 1.0  → value at next key
- bias < 0.0  → overshoot past previous key
- bias > 1.0  → overshoot past next key
"""
