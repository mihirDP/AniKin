...
- Querying and resetting hotkeys.
"""
...
BINDABLE_TOOLS = [
    {
        ...
        "category": "Transform",
        "command": "import anikin.tools.align as al; al.execute(True, True)"
    },
    {
        "id": "align_t",
        "name": "Align Translation Only",
        "category": "Transform",
        "command": "import anikin.tools.align as al; al.execute(True, False)"
    },
    {
        "id": "align_r",
        "name": "Align Rotation Only",
        "category": "Transform",
        "command": "import anikin.tools.align as al; al.execute(False, True)"
    },
    {
        "id": "nudge_left_1",
        "name": "Nudge Left 1 Frame",
        "category": "Timing",
        "command": "import anikin.tools.nudge as nd; nd.execute(-1)"
    },
    {
        "id": "nudge_right_1",
    ...
    },
    {
        ...
        "category": "Timing",
        "command": "import anikin.tools.nudge as nd; nd.execute(-5)"
    },
    {
        "id": "nudge_right_5",
    ...
    },
    {
        ...
        "category": "Timing",
        "command": "import anikin.tools.anim_offset as ao; ao.execute(2)"
    },
    {
        "id": "tangent_auto",
        "name": "Set Tangent Auto",
        "category": "Tangents",
        "command": "import anikin.tools.tangents as tg; tg.set_tangent('auto')"
    },
    {
        "id": "tangent_flat",
        "name": "Set Tangent Flat",
        "category": "Tangents",
        "command": "import anikin.tools.tangents as tg; tg.set_tangent('flat')"
    },
    {
        "id": "tangent_linear",
        "name": "Set Tangent Linear",
        "category": "Tangents",
        "command": "import anikin.tools.tangents as tg; tg.set_tangent('linear')"
    },
    {
        "id": "tangent_step",
        "name": "Set Tangent Stepped",
        "category": "Tangents",
        "command": "import anikin.tools.tangents as tg; tg.set_tangent('step')"
    },
    {
        "id": "tangent_spline",
        "name": "Set Tangent Spline",
        "category": "Tangents",
        "command": "import anikin.tools.tangents as tg; tg.set_tangent('spline')"
    },
    {
        "id": "bake_to_loc",
        "name": "Smart Bake to Locator",
        "category": "Workflow",
        "command": "import anikin.tools.smart_bake as sb; sb.bake_to_locator()"
    },
    {
        "id": "bake_from_loc",
        "name": "Smart Bake from Locator",
        "category": "Workflow",
        "command": "import anikin.tools.smart_bake as sb; sb.bake_from_locator()"
    },
    {
        "id": "toggle_motion_trail",
        "name": "Toggle Motion Trail",
        "category": "Visualization",
        "command": "import anikin.tools.motion_trail as mt; mt.toggle_motion_trail()"
    },
    {
        "id": "toggle_ghosting",
        "name": "Toggle Ghosting",
        "category": "Visualization",
        "command": "import anikin.tools.ghosting as gh; gh.toggle_ghosting()"
    },
    {
        "id": "euler_filter",
        "name": "Euler Filter",
        "category": "Curves",
        "command": "import anikin.tools.smooth as sm; sm.euler_filter()"
    },
    {
        "id": "smooth_curves",
        "name": "Smooth Curves",
        "category": "Curves",
        "command": "import anikin.tools.smooth as sm; sm.smooth_curves()"
    }
]
